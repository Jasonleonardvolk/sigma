# GitHub Repo Updates -- 2026-05-25
# The scout version. Make them need it.

================================================
1. SIGMA REPO (github.com/Jasonleonardvolk/sigma)
================================================

DESCRIPTION (one-liner, paste into GitHub Settings > General):

The verification layer your AI stack is missing. Structural contradiction detection via cellular sheaf cohomology. 5M vertices. 35 microseconds per edit. Zero drift. Zero ML.

---

================================================
2. SIGMA-GUARD REPO (github.com/Jasonleonardvolk/sigma-guard)
================================================

REPLACE THE ENTIRE TOP SECTION of README.md with this:
...
| Cohomology drift | **0 (verified by full recompute at 1M)** |
...
not 5M. Drift is verified to be exactly zero by full recomputation at
1,000,000 vertices and smaller scales; at 5M the streamed edits produced
zero cohomology changes on flush.
...
Everything below "What am I looking at?" can stay as-is.

---

ALSO UPDATE the "About" section (GitHub sidebar):

OLD: "Deterministic infra layer"
NEW: "Structural verification for graph databases. 5M vertices. 35 microseconds per edit. Zero ML."

---

================================================
3. AFTER ACCEPTANCE ONLY (camera-ready June 25)
================================================

Add to Citation section:

```
@inproceedings{volk2026sheafguarded,
  title={Sheaf-Guarded Updates: Streaming Structural Verification
         for Evolving Agent State},
  author={Volk, Jason L.},
  booktitle={AI4Math Workshop at ICML 2026},
  year={2026}
}
```

Add a badge at the top of README:

```
[![Paper](https://img.shields.io/badge/ICML%202026-AI4Math%20Workshop-blue)](LINK)
```

Add one line under Performance:

"Peer-reviewed at the AI4Math Workshop at ICML 2026 (Seoul).
Paper: [Sheaf-Guarded Updates](LINK)"

Do NOT add any of this before acceptance notification (June 15).

================================================
4. DO NOT CHANGE
================================================

- Author name, Invariant Research references, invariant.pro
  links: leave them. They are pre-existing public content.
- BSL license terms and pricing tiers: leave them.
- Docker examples: leave them.
- No "under review" or "submitted to ICML" language anywhere
